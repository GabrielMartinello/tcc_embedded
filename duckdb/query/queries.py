...
"""
query_votos_zonas_mais_demoradas=f"""
select z.zone_code,
    z.tempo_voto as tempo_zona
from (select y.uf,
            y.city_code,
            y.zone_code,
            y.section_code,
...
from (select x.*,
             (select max(vt.event_timestamp)
              ...
              where vt.event_system = x.event_system
                ...
                and vt.section_code = x.section_code
                and vt.some_id = x.urna_num
                and julian(vt.event_timestamp) < x.tempo_final
...
query_tempo_voto_cidade=f"""
select z.city_code,
    z.tempo_voto as tempo_cidade
from (select y.uf,
            y.city_code,
            y.zone_code,
            y.section_code,
